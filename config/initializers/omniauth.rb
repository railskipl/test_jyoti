...
Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  provider :google_oauth2, '537798958660-1rokanhb4ciitb8h1oipocnf07mbjje0.apps.googleusercontent.com','rJY0iMCDy06n9N0JkbKFqUQu',{:access_type => 'online', :approval_prompt => 'auto', :client_id => 'm360.herokuapp.com'}
end
