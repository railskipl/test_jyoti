...
Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  provider :google_oauth2, '881639063021-cna2s7l4sqot6vh1kf2s735vhi6gbl7d.apps.googleusercontent.com','9CnwRY9v0a1q-xd7civFE9D5',{:access_type => 'offline', :approval_prompt => 'auto', :client_id => 'm360.herokuapp.com',:provider_ignores_state => 'true'}
end
