...
Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  provider :google_oauth2, '537798958660-1fpn0aotrj91u67d49t5pkalpc98q4oj.apps.googleusercontent.com','rJY0iMCDy06n9N0JkbKFqUQu',{:access_type => 'online', :approval_prompt => 'auto', :client_id => 'm360.herokuapp.com',:provider_ignores_state => 'true'}
end
